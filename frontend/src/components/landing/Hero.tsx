    ...
    <section className="relative overflow-hidden pt-[88px]">
      ...
      <div
        ...
        style={{
          ...
          width: "1100px",
          height: "900px",
          background: "radial-gradient(ellipse at center, rgba(124, 107, 240, 0.225) 0%, rgba(124, 107, 240, 0.075) 40%, transparent 70%)",
          filter: "blur(80px)",
        }}
      />

      <Container className="relative z-10 flex min-h-[calc(100vh-480px)] flex-col justify-center py-10 pb-10">
